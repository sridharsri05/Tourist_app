        ...
        <section>
            ...
            <div className=' d-flex '>
                ...
                <div className='  ms-3 mt-2  '>
                    <h6 className=' fw-bold '> Theerthamalai Temple, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3 mt-2  '>
                    <h6 className=' fw-bold '> Hogenakkal Falls, Overview</h6>
                ...
                <div className=' '>
                    <img src={ch2} alt=" " style={{ height: '228px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                ...
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Pennagram Village, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3  mt-2 '>
                    <h6 className=' fw-bold '> Mettur Dam, Overview</h6>
                ...
                <div >
                    <img src={ch4} alt=" " style={{ height: '230px', width: '200px' }} />
                </div>
...
export default HogenakkalPlace